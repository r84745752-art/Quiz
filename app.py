...
<body>
    <div class="container">
        ...
        <div class="result-container" id="result-container">
            <h2 style="text-align: center; color: #2d3748; margin-bottom: 20px;">Your Results</h2>
    ...
    <script>
        ...
        function restartQuiz() {{
            ...
            document.getElementById('detailed-questions').innerHTML = '';
        }}
