            ...
            for block in question_blocks:
                ...
                if len(lines) >= 7:
                    ...
                    question = {
                        ...
                        'text': lines[1],
                        'options': lines[2:6],
                        'correct_option': str(lines[6]).strip(),  # Ensure string
    ...
    <div class="container">
        ...
        <div class="quiz-interface" id="quiz-interface">
            <header>
                ...
                <div class="quiz-info" style="display: flex; justify-content: space-around; margin-top: 15px; flex-wrap: wrap;">
                    <div class="info-item" style="background: rgba(102, 126, 234, 0.1); color: #667eea; padding: 12px 20px; border-radius: 25px; margin: 5px;">
        ...
        <div class="result-container" id="result-container" style="display: none;">
            ...
            <p class="performance-message" id="result-message" style="font-size: 1.2rem; color: #4a5568; margin: 20px 0;"></p>
            <div class="score-breakdown" id="score-breakdown">
                <div class="breakdown-item correct">
                    <div class="breakdown-number" id="correct-count" style="font-size: 1.5rem;">0</div>
                    <div class="breakdown-label" style="font-size: 0.9rem;">Correct</div>
                </div>
                <div class="breakdown-item incorrect">
                    <div class="breakdown-number" id="incorrect-count" style="font-size: 1.5rem;">0</div>
                    <div class="breakdown-label" style="font-size: 0.9rem;">Incorrect</div>
                </div>
                <div class="breakdown-item skipped">
                    <div class="breakdown-number" id="skipped-count" style="font-size: 1.5rem;">0</div>
                    <div class="breakdown-label" style="font-size: 0.9rem;">Skipped</div>
                </div>
            </div>
